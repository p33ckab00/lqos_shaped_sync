...
pub fn self_test_payload(payload: &Value) -> (Value, Vec<Diagnostic>, Vec<Diagnostic>) {
    ...
    let mut full_backend_readiness_payload = service_runtime_handoff_payload.clone();
    if let Some(obj) = full_backend_readiness_payload.as_object_mut() {
        obj.insert("confirmation".to_string(), json!("CONFIRM_FULL_RUST_BACKEND_PRODUCTION_READINESS_CONTRACT"));
        obj.insert("rust_backend_service_runtime_handoff_contract".to_string(), json!(service_runtime_handoff.clone()));
        obj.insert("webui_ux_unchanged".to_string(), json!(true));
        obj.insert("webui_static_asset_paths_unchanged".to_string(), json!(true));
        obj.insert("operator_final_review_ack".to_string(), json!(true));
        if let Some(rc) = obj.get_mut("rust_core").and_then(Value::as_object_mut) {
    ...
    let (full_backend_readiness, full_backend_readiness_errors, _full_backend_readiness_warnings) = build_full_rust_backend_production_readiness_contract_payload(&full_backend_readiness_payload);
    let full_backend_readiness_ok = full_backend_readiness_errors.is_empty()
        && full_backend_readiness.get("status").and_then(Value::as_str) == Some("full_rust_backend_production_readiness_contract_ready")
        && full_backend_readiness.get("full_rust_backend_production_readiness_ready").and_then(Value::as_bool) == Some(true)
        && full_backend_readiness.get("full_rust_backend_production_enabled").and_then(Value::as_bool) == Some(false)
        && full_backend_readiness.get("python_backend_removed").and_then(Value::as_bool) == Some(false);
    checks.push(check("full_rust_backend_production_readiness_contract", full_backend_readiness_ok, json!({
        "status": full_backend_readiness.get("status"),
        "full_rust_backend_production_readiness_ready": full_backend_readiness.get("full_rust_backend_production_readiness_ready"),
        "python_backend_removed": full_backend_readiness.get("python_backend_removed")
    })));
    if !full_backend_readiness_ok {
        errors.push(Diagnostic::error("self_test_full_rust_backend_production_readiness_failed", Some("build-full-rust-backend-production-readiness-contract".to_string()), "Self-test full Rust backend production-readiness contract should report ready without removing Python or switching service/API runtime authority."));
    }

    let mut full_backend_cutover_payload = full_backend_readiness_payload.clone();
    if let Some(obj) = full_backend_cutover_payload.as_object_mut() {
        obj.insert("confirmation".to_string(), json!("CONFIRM_FULL_RUST_BACKEND_CUTOVER_PLAN"));
        obj.insert("full_rust_backend_production_readiness_contract".to_string(), json!(full_backend_readiness.clone()));
        obj.insert("rollback_path".to_string(), json!("python_backend_reenable_and_flask_route_restore"));
        obj.insert("operator_cutover_approval_ack".to_string(), json!(true));
        obj.insert("webui_ux_unchanged".to_string(), json!(true));
        obj.insert("webui_static_asset_paths_unchanged".to_string(), json!(true));
        if let Some(rc) = obj.get_mut("rust_core").and_then(Value::as_object_mut) {
    ...
    let (full_backend_cutover, full_backend_cutover_errors, _full_backend_cutover_warnings) = build_full_rust_backend_cutover_plan_payload(&full_backend_cutover_payload);
    let full_backend_cutover_ok = full_backend_cutover_errors.is_empty()
        && full_backend_cutover.get("status").and_then(Value::as_str) == Some("full_rust_backend_cutover_plan_ready")
        && full_backend_cutover.get("full_rust_backend_cutover_plan_ready").and_then(Value::as_bool) == Some(true)
        && full_backend_cutover.get("python_backend_removed").and_then(Value::as_bool) == Some(false)
        && full_backend_cutover.get("python_removal_allowed").and_then(Value::as_bool) == Some(false);
    checks.push(check("full_rust_backend_cutover_plan", full_backend_cutover_ok, json!({
        "status": full_backend_cutover.get("status"),
        "full_rust_backend_cutover_plan_ready": full_backend_cutover.get("full_rust_backend_cutover_plan_ready"),
        "python_backend_removed": full_backend_cutover.get("python_backend_removed")
    })));
    if !full_backend_cutover_ok {
        errors.push(Diagnostic::error("self_test_full_rust_backend_cutover_failed", Some("build-full-rust-backend-cutover-plan".to_string()), "Self-test full Rust backend cutover plan should report ready without removing Python or switching API traffic."));
    }

    let mut full_backend_cutover_execution_payload = full_backend_cutover_payload.clone();
    if let Some(obj) = full_backend_cutover_execution_payload.as_object_mut() {
        obj.insert("confirmation".to_string(), json!("CONFIRM_FULL_RUST_BACKEND_CUTOVER_EXECUTION_CONTRACT"));
        obj.insert("full_rust_backend_cutover_plan".to_string(), json!(full_backend_cutover.clone()));
        obj.insert("operator_cutover_execution_ack".to_string(), json!(true));
        if let Some(rc) = obj.get_mut("rust_core").and_then(Value::as_object_mut) {
    ...
    let (full_backend_cutover_execution, full_backend_cutover_execution_errors, _full_backend_cutover_execution_warnings) = build_full_rust_backend_cutover_execution_contract_payload(&full_backend_cutover_execution_payload);
    let full_backend_cutover_execution_ok = full_backend_cutover_execution_errors.is_empty()
        && full_backend_cutover_execution.get("status").and_then(Value::as_str) == Some("full_rust_backend_cutover_execution_contract_ready")
        && full_backend_cutover_execution.get("full_rust_backend_cutover_execution_contract_ready").and_then(Value::as_bool) == Some(true)
        && full_backend_cutover_execution.get("python_backend_removed").and_then(Value::as_bool) == Some(false)
        && full_backend_cutover_execution.get("api_traffic_switched_to_rust").and_then(Value::as_bool) == Some(false);
    checks.push(check("full_rust_backend_cutover_execution_contract", full_backend_cutover_execution_ok, json!({
        "status": full_backend_cutover_execution.get("status"),
        "full_rust_backend_cutover_execution_contract_ready": full_backend_cutover_execution.get("full_rust_backend_cutover_execution_contract_ready"),
        "python_backend_removed": full_backend_cutover_execution.get("python_backend_removed")
    })));
    ...
    let mut python_removal_payload = rust_backend_enablement_payload.clone();
    if let Some(obj) = python_removal_payload.as_object_mut() {
        obj.insert("confirmation".to_string(), json!("CONFIRM_PYTHON_BACKEND_REMOVAL_EXECUTION_CONTRACT"));
        obj.insert("rust_backend_production_enablement_contract".to_string(), json!(rust_backend_enablement.clone()));
        obj.insert("operator_python_backend_removal_execution_ack".to_string(), json!(true));
        obj.insert("rollback_path".to_string(), json!("restore_python_backend_and_flask_routes"));
        if let Some(rc) = obj.get_mut("rust_core").and_then(Value::as_object_mut) {
    ...
    let (python_removal, python_removal_errors, _python_removal_warnings) = build_python_backend_removal_execution_contract_payload(&python_removal_payload);
    let python_removal_ok = python_removal_errors.is_empty()
        && python_removal.get("status").and_then(Value::as_str) == Some("python_backend_removal_execution_contract_ready")
        && python_removal.get("python_backend_removal_candidate").and_then(Value::as_bool) == Some(true)
        && python_removal.get("python_backend_removed").and_then(Value::as_bool) == Some(false)
        && python_removal.get("api_traffic_switched_to_rust").and_then(Value::as_bool) == Some(false);
    checks.push(check("python_backend_removal_execution_contract", python_removal_ok, json!({
        "status": python_removal.get("status"),
        "python_backend_removal_candidate": python_removal.get("python_backend_removal_candidate"),
        "python_backend_removed": python_removal.get("python_backend_removed")
    })));
    if !python_removal_ok {
        errors.push(Diagnostic::error("self_test_python_backend_removal_execution_failed", Some("build-python-backend-removal-execution-contract".to_string()), "Self-test Python backend removal execution contract should report ready without removing Python or switching API traffic."));
    }

    let mut full_removal_rehearsal_payload = python_removal_payload.clone();
    if let Some(obj) = full_removal_rehearsal_payload.as_object_mut() {
        obj.insert("confirmation".to_string(), json!("CONFIRM_FULL_RUST_BACKEND_REMOVAL_REHEARSAL"));
        obj.insert("python_backend_removal_execution_contract".to_string(), json!(python_removal.clone()));
        obj.insert("operator_full_rust_backend_removal_rehearsal_ack".to_string(), json!(true));
        obj.insert("rollback_path".to_string(), json!("restore_python_backend_and_flask_routes"));
        if let Some(rc) = obj.get_mut("rust_core").and_then(Value::as_object_mut) {
    ...
    let (full_removal_rehearsal, full_removal_rehearsal_errors, _full_removal_rehearsal_warnings) = build_full_rust_backend_removal_rehearsal_payload(&full_removal_rehearsal_payload);
    let full_removal_rehearsal_ok = full_removal_rehearsal_errors.is_empty()
        && full_removal_rehearsal.get("status").and_then(Value::as_str) == Some("full_rust_backend_removal_rehearsal_ready")
        && full_removal_rehearsal.get("python_backend_removed").and_then(Value::as_bool) == Some(false)
        && full_removal_rehearsal.get("api_traffic_switched_to_rust").and_then(Value::as_bool) == Some(false);
    checks.push(check("full_rust_backend_removal_rehearsal", full_removal_rehearsal_ok, json!({
        "status": full_removal_rehearsal.get("status"),
        "full_rust_backend_candidate": full_removal_rehearsal.get("full_rust_backend_candidate"),
        "python_backend_removed": full_removal_rehearsal.get("python_backend_removed")
    })));
    ...
    let mut full_production_verifier_payload = full_production_cutover_payload.clone();
    if let Some(obj) = full_production_verifier_payload.as_object_mut() {
        obj.insert("confirmation".to_string(), json!("CONFIRM_FULL_RUST_BACKEND_PRODUCTION_VERIFIER"));
        obj.insert("full_rust_backend_production_cutover".to_string(), json!(full_production_cutover.clone()));
        obj.insert("rust_service_active".to_string(), json!(true));
        obj.insert("rust_api_healthcheck_passed".to_string(), json!(true));
        obj.insert("rust_unix_socket_active".to_string(), json!(true));
        obj.insert("api_traffic_switched_to_rust".to_string(), json!(true));
        obj.insert("flask_routes_disabled".to_string(), json!(true));
        obj.insert("python_backend_stopped_or_disabled".to_string(), json!(true));
        obj.insert("production_healthcheck_passed".to_string(), json!(true));
        obj.insert("operator_full_rust_backend_production_verifier_ack".to_string(), json!(true));
        if let Some(rc) = obj.get_mut("rust_core").and_then(Value::as_object_mut) {
    ...
    let (full_production_verifier, full_production_verifier_errors, _full_production_verifier_warnings) = build_full_rust_backend_production_verifier_payload(&full_production_verifier_payload);
    let full_production_verifier_ok = full_production_verifier_errors.is_empty()
        && full_production_verifier.get("status").and_then(Value::as_str) == Some("full_rust_backend_production_verified")
        && full_production_verifier.get("full_rust_backend").and_then(Value::as_bool) == Some(true)
        && full_production_verifier.get("python_retirement_executor_allowed").and_then(Value::as_bool) == Some(true)
        && full_production_verifier.get("webui_ux_unchanged").and_then(Value::as_bool) == Some(true);
    checks.push(check("full_rust_backend_production_verifier", full_production_verifier_ok, json!({
        "status": full_production_verifier.get("status"),
        "full_rust_backend": full_production_verifier.get("full_rust_backend"),
        "python_retirement_executor_allowed": full_production_verifier.get("python_retirement_executor_allowed")
    })));
    ...
    let mut drift_monitor_payload = steady_state_payload.clone();
    if let Some(obj) = drift_monitor_payload.as_object_mut() {
        obj.insert("confirmation".to_string(), json!("CONFIRM_FULL_RUST_BACKEND_PRODUCTION_DRIFT_MONITOR"));
        obj.insert("full_rust_backend_steady_state_guard".to_string(), json!(steady_state.clone()));
        obj.insert("drift_monitor_healthcheck_passed".to_string(), json!(true));
        obj.insert("drift_check_count".to_string(), json!(1));
        obj.insert("python_backend_process_count".to_string(), json!(0));
        obj.insert("python_backend_service_reenabled".to_string(), json!(false));
        obj.insert("operator_full_rust_backend_drift_monitor_ack".to_string(), json!(true));
        if let Some(rc) = obj.get_mut("rust_core").and_then(Value::as_object_mut) {
            rc.insert("full_rust_backend_production_drift_monitor_pilot".to_string(), json!(true));
            rc.insert("allow_full_rust_backend_production_drift_monitor".to_string(), json!(true));
            rc.insert("full_rust_backend_production_drift_monitor_mode".to_string(), json!("monitor_only"));
            rc.insert("full_rust_backend_drift_monitor_require_steady_state_guard".to_string(), json!(true));
            rc.insert("full_rust_backend_drift_monitor_require_runtime_health".to_string(), json!(true));
            rc.insert("full_rust_backend_drift_monitor_require_no_python_drift".to_string(), json!(true));
            rc.insert("full_rust_backend_drift_monitor_require_webui_unchanged".to_string(), json!(true));
            rc.insert("full_rust_backend_drift_monitor_require_rollback_package".to_string(), json!(true));
            rc.insert("full_rust_backend_drift_monitor_require_server_tests".to_string(), json!(true));
            rc.insert("full_rust_backend_drift_monitor_require_manual_confirmation".to_string(), json!(true));
            rc.insert("full_rust_backend_drift_monitor_require_operator_ack".to_string(), json!(true));
            rc.insert("full_rust_backend_drift_monitor_max_shadow_age_seconds".to_string(), json!(900));
        }
    }
    let (drift_monitor, drift_monitor_errors, _drift_monitor_warnings) = build_full_rust_backend_production_drift_monitor_payload(&drift_monitor_payload);
    let drift_monitor_ok = drift_monitor_errors.is_empty()
        && drift_monitor.get("status").and_then(Value::as_str) == Some("full_rust_backend_production_drift_monitor_healthy")
        && drift_monitor.get("full_rust_backend").and_then(Value::as_bool) == Some(true)
        && drift_monitor.get("python_drift_absent").and_then(Value::as_bool) == Some(true);
    checks.push(check("full_rust_backend_production_drift_monitor", drift_monitor_ok, json!({
        "status": drift_monitor.get("status"),
        "full_rust_backend": drift_monitor.get("full_rust_backend"),
        "python_drift_absent": drift_monitor.get("python_drift_absent")
    })));
    if !drift_monitor_ok {
